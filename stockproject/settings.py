...
SECRET_KEY = 'django-insecure-we5pekkc^ufa7$vvt(8+%gqseq=tr-nsxkdsvnh3i=v-zr_&(0'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'sft1_db',     # Set your database name
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': 'logfile.log',  # Relative path in the project directory
        },
    },
    'loggers': {
        'django': {
